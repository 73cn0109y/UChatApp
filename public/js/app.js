...
/***/ function(module, exports, __webpack_require__) {
	...
	var settings_component_1 = __webpack_require__(358);
	var login_component_1 = __webpack_require__(361);
	var register_component_1 = __webpack_require__(364);
	var chat_component_1 = __webpack_require__(367);
	// Services
	var authProvider_1 = __webpack_require__(61);
	var chatProvider_1 = __webpack_require__(368);
	var settingsProvider_1 = __webpack_require__(678);
	// Pipes
	var appRoutes = [
	    {
	        path: 'login',
	...
	var AppComponent = (function () {
	    function AppComponent(router, authProvider, zone) {
	        ...
	        this.authProvider.isLoggedIn.subscribe(function (value) {
	            _this.router.navigate([value ? '/home' : '/login']);
	...
	var AuthProvider = (function () {
	    ...
	    AuthProvider.prototype.getToken = function () {
	        ...
	        ipc.once('get-token', function (e, data) {
	            if (data && data.token)
	                _this.validateToken(data.token);
	            else
	                _this.setToken(null);
	        });
	        ipc.send('get-token');
	    ...
	    AuthProvider.prototype.setToken = function (e, ipcEmit) {
	        ...
	        if (ipcEmit) {
	            ipc.once('set-token', function (e, data) { return _this.setToken(data.token); });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SettingsPage = (function () {
	    function SettingsPage(http, authProvider, settingsProvider, _ngZone) {
	        var _this = this;
	        this.http = http;
	        this.authProvider = authProvider;
	        ...
	        this.settingsProvider.Settings.subscribe(function (value) {
	            _this._ngZone.run(function () { return _this.settings = value; });
	            console.log(value);
	        });
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatPage = (function () {
	    function ChatPage(chatProvider, settingsProvider) {
	        ...
	        this.chatProvider.Messages.subscribe(function (value) { return _this.messages = value; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var io = __webpack_require__(369);
	var ChatProvider = (function () {
	    ...
	    ChatProvider.prototype.setupSocket = function () {
	        ...
	        var host = (process.env.NODE_ENV === 'production' ? '' : 'http://localhost:8080') + '?token=' + this._token;
	        ...
	        this._socket.on('message', function (data) {
	            ...
	            if (_this._messages.length > 100)
	                _this._messages.splice(0, _this._messages.length - 100);
	            _this.Messages.next(_this._messages);
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Manager = __webpack_require__(386);
	var debug = __webpack_require__(372)('socket.io-client');
	...
	exports.Manager = __webpack_require__(386);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(372)('socket.io-client:url');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.humanize = __webpack_require__(374);
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function () {
	  ...
	  var isLoader = "function" === "function" && __webpack_require__(381);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var debug = __webpack_require__(372)('socket.io-client:manager');
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 *
	 */
	module.exports.parser = __webpack_require__(396);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Emitter = __webpack_require__(404);
	var debug = __webpack_require__(408)('engine.io-client:socket');
	var index = __webpack_require__(413);
	var parser = __webpack_require__(396);
	var parseuri = __webpack_require__(371);
	var parsejson = __webpack_require__(414);
	var parseqs = __webpack_require__(405);
	...
	Socket.Transport = __webpack_require__(395);
	Socket.transports = __webpack_require__(390);
	Socket.parser = __webpack_require__(396);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(391);
	var XHR = __webpack_require__(393);
	var JSONP = __webpack_require__(410);
	var websocket = __webpack_require__(411);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var XMLHttpRequest = __webpack_require__(391);
	var Polling = __webpack_require__(394);
	var Emitter = __webpack_require__(404);
	var inherit = __webpack_require__(406);
	var debug = __webpack_require__(408)('engine.io-client:polling-xhr');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transport = __webpack_require__(395);
	var parseqs = __webpack_require__(405);
	var parser = __webpack_require__(396);
	var inherit = __webpack_require__(406);
	var yeast = __webpack_require__(407);
	var debug = __webpack_require__(408)('engine.io-client:polling');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var inherit = __webpack_require__(406);
	var yeast = __webpack_require__(407);
	var debug = __webpack_require__(408)('engine.io-client:websocket');
	var BrowserWebSocket = global.WebSocket || global.MozWebSocket;
	var NodeWebSocket;
	if (typeof window === 'undefined') {
	  try {
	    NodeWebSocket = __webpack_require__(412);
	  } catch (e) { }
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var on = __webpack_require__(417);
	var bind = __webpack_require__(418);
	var debug = __webpack_require__(372)('socket.io-client:socket');
