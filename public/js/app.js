...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = (function () {
	    ...
	    AppComponent.prototype.openGameWindow = function () {
	        var host = (core_1.isDevMode() ? 'http://localhost:8080/' : 'https://uchatapi-frosenos.rhcloud.com:8443/');
	        window.open('./games.html?token=' + this.authProvider.token + '&host=' + host, 'UChat - Game', 'width=400,height=300,minWidth=400,minHeight=300');
	    };
	    return AppComponent;
	}());
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ChatPage = (function () {
	    ...
	    ChatPage.prototype.reconnectLiveCoding = function () {
	        if (this.serviceStatus.Liveedu.toLowerCase() !== 'Reconnect')
	            return;
